...
// if (userInput < 0) {
//     var absl = Math.abs(userInput);
//     document.write("The absolute value of "+ userInput + " is " + absl);
// }

//Question-04
// var dice1 = Math.round(Math.random() * 10);
// var dice2 = Math.round(Math.random() * 10);
// document.write("random dice value : " + dice1 + "<br>");
// document.write("random dice value : " + dice2);

//Question-05
// var forHead = Math.round(Math.random() * 2);
// var forTail = Math.round(Math.random() * 2);
// document.write(forHead+"<br>");
// document.write("random coin value : Heads" + "<br>");
// document.write(forTail+"<br>");
...
// if (userWeight == 50 || userWeight == "50Kgs" || userWeight == "50.2Kgs"|| userWeight == "52.2Killograms") {
//     document.write("The  weight of user is " + userWeight);
// }

//Question-08
// var userNum = +prompt("Enter a number between 1 to 10");
// var compNum = Math.round(Math.random() * 10);
// if (userNum === compNum) {
// document.write("Congratualation you won!");
// }else {
//     document.write("Sorry! are lose.");
// }
...
//Question-03
// var date = new Date();
// var days = ["Sun", "Mon", "Thu", "Wed", "Thi", "Fri", "Sat"];
...
// }else {
//     document.write("It is not fun day");
// }
...
// var minuts = milliseconds / (1000 * 60) ;
// document.write("Current date : " + date + "<br>");
// document.write("Elapsed  milliseconds since january 1, 1970 : " + milliseconds + "<br>");
// document.write("Elapsed minuts since january 1, 1970 : " + minuts + "<br>");
...
//     check_Am_Pm = "AM ";
// }
// document.write("It's  "+check_Am_Pm);
...
//Question-09
// var pastRamadan = new Date("18 Jun 2022");
// var currRamadan = new Date("23 Mar 2023");
// var calcDays = (currRamadan.getTime() -  pastRamadan.getTime()) / (1000 * 60 * 60 * 24);
// document.write(calcDays + "  days have passed since 1st Ramadan, 2015");

//Question-10
// var date1 = new Date();
// var date2 = new Date("1 Jan 2023");
// var seconds = Math.round((date1.getTime() - date2.getTime()) / 1000 );
// document.write("On reference date " + date1 + ",<br>");
// document.write(seconds + "  seconds had passed since bigning of  " + date1.getFullYear());

//Question-11
// var currDate1 = new Date();
// var hours = currDate1.setHours(12);
// document.write("current date " + currDate1 + "<br>");
// var currDate2 = new Date();
// document.write("1 hours ago, it was " + currDate2);

//Question-12
// var date1 = new Date();
// document.write("current date :"+date1 + "<br>")
// var date2 = new Date(date1.setFullYear(date1.getFullYear() - 100));
// document.write("100 Year back, it was : "+date2);

//Question-13
// var userAge = +prompt("Enter your age");
// var date = new Date();
// var year = date.getFullYear();
// var calc = year - userAge;
// document.write("Your age is " + userAge +"<br>");
// document.write("Your birth year is " + calc);
...
//     return fullName;
// }
// document.write(fullNam( "Asslum O alikum " + "Ashraf ", "ali"));
...
//     }
// }
// document.write(result(num1, num2, operator));
...
// return num1 + num2 ;
// }
// document.write(square(square(num1,num2), square(num1, num2)));
//or
// var num1 = +prompt("Enter first number")
// var num2 = +prompt("Enter first number")
// function square(num1, num2) {
...
// }
// document.write(square(num1,num2));
...
//     return fact; 
// }
// document.write(facto(num));
//or 
// var num = +prompt("Enter a number");
// function facto(num){
//     var fact = 1;
//     for (var num = num; num > 0; num--){
//     fact = fact * num;
//     }
//     return fact; 
// }
...
//Question-08
// var base = +prompt("Enter base of an angle");
// var pependicular = +prompt("Enter perpendicular of an angle");
// function calculateHypotenuse() {
//     return function calculateSquare(base, pependicular) {
//         return base ** 2 + pependicular ** 2;
//     }
// }
// document.write("Hypotenuse is :" + calculateHypotenuse()(base, pependicular));

//Question-09
// function areaOfTriangel(width, height) {
//    var A = width * height; // A for area of triangle
//    return A;
// }
// document.write(areaOfTriangel(2, 3));

//Question-10
// var userInput = prompt("Enter a string ");
// function palindrome(userInput) {
//     var word = userInput.split("").reverse().join("");
//     if (word === userInput) {
//         document.write("This word is palindrome word!");
//     } else {
//         document.write("This word is not palindrome word");
//     }
// }
...
//         if (messageArr[i].length > messageArr[j].length) {
//          stor = messageArr[i];
//         }
//        else if (messageArr[i].length < messageArr[j].length) {
//          stor = messageArr[j];
//         }
//     }
// }
...
//         }
//     }
//     console.log(letter + " " + conunt + " times in this message");
// }
// countLetter("JSResourceS.com", "o");

//Question-14
// function calcCircumference(radius) {
//   let circumferenceOFCircle = "The circumFerence is : " + (Math.round(2 * (Math.PI) * radius));
//   console.log(circumferenceOFCircle);
// }
// calcCircumference(2);

// function calcArea(radius) {
//     let areaOFCircle ="The area of circle is : " +(Math.round((Math.PI) * (radius ** 2)));
